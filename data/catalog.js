...
export const CATEGORY_DEFINITIONS = {
  "화장품": {
    forms: ["에센스", "크림", "세럼", "마스크팩", "선크림", "클렌저"],
    functions: ["항산화", "항염", "미백", "주름개선/항노화", "보습", "피부장벽 강화/진정", "자외선 차단", "여드름/피지조절", "탈모방지/두피개선"]
  },
  "건강기능식품": {
    forms: ["정제", "캡슐", "분말", "액상", "스틱형"],
    functions: ["항산화", "항당뇨", "간기능 개선", "면역력 증진", "관절건강", "장건강", "피로회복", "콜레스테롤/혈행개선", "체지방감소/다이어트", "인지기능개선", "눈건강", "스트레스완화/수면"]
  },
  "펫푸드/펫케어": {
    forms: ["사료첨가제", "영양제", "샴푸", "간식"],
    functions: ["피부/모질 관리", "장건강", "면역력 증진", "관절건강", "항산화", "영양 보충", "샴푸/피부 진정"]
  },
  "기능성 식품/음료": {
    forms: ["차", "스낵", "발효음료"],
  ...
  "의약외품": {
    forms: ["구강케어", "위생 관련 제품"],
    functions: ["항균/항미생물", "구강 관리", "위생", "피부 보호", "상처재생"]
  },
  "원료 소재 B2B 공급": {
    forms: ["추출물 원료", "기능성 원료", "콜라겐 원료", "보습 소재"],
    functions: ["항산화", "항염", "보습", "주름개선/항노화", "항균/항미생물"]
  },
  "위생/세정용품": {
    forms: ["천연 세정제", "샴푸", "클렌저", "항균 세정 제품"],
    functions: ["항균/항미생물", "위생", "피부 보호"]
  },
  "사료첨가제": {
    forms: ["축산용 첨가제", "수산용 첨가제", "반려동물용 첨가제"],
    functions: ["장건강", "면역력 증진", "관절건강", "항산화", "영양 보충"]
  },
  "친환경 소재/바이오 플라스틱": {
...
export const EVIDENCE_PROFILES = {
  ...
  "벌꿀": {
    ...
    recentPatentCount: 8,
    productionTons: 410,
    productionVariation: 18.7,
    mfdsName: "Honey Extract",
    casNo: "8028-66-8",
    restriction: "알레르기와 제품 유형별 당류 기준 확인 필요"
  },
  "프로폴리스": {
    paperCount: 46,
    recentPaperCount: 20,
